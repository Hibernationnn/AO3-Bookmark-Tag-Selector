...
(() => {
    ...
    let bookmarkerTagsCache = null;

    let isScanningBookmarks = false;
...
#ao3-my-tags-refresh.rotating {
    animation: ao3Rotate .6s linear;
}
...
@keyframes ao3Rotate {
    ...
    to {
        ...
        .ao3-import-bookmark-tags:hover {
        ...
        .ao3-import-bookmark-tags:active {
    ...
    bookmarks.forEach(
        bookmark => {
            ...
            const tags =
                bookmark.querySelectorAll(
                    '.own.user.module .meta.tags a.tag'
                );
...
isScanningBookmarks = true;


async function readAllBookmarkersTags() {

    

    isScanningBookmarks = true;

    if (bookmarkerTagsCache) {

        return {
            found: true,
            tags: bookmarkerTagsCache
        };
...
async function showPartialImport(){
